...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('penitipans', function (Blueprint $table) {
            ...
            $table->enum('status', ['menunggu pembayaran', 'Pembayaran Gagal', 'menunggu penjemputan', 'menunggu diantar ke pethouse', 'sedang dititipkan', 'selesai'])->default('menunggu pembayaran');
