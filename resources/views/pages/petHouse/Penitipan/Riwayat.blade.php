<x-pethouse-layout header="Daftar Riwayat Penitipan" class="p-5 md:p-10 md:mb-0" id="content" activeMenu="Penitipan">
                        ...
                        <div class="relative">
                            @if ($penitipan->users->profilePicture)
                                <img src="{{ $penitipan->users->profilePicture }}" alt="{{ $penitipan->users->name }}"
                                    class="w-12 h-12 rounded-full object-cover border-2" style="border-color: #F69246;">
                            @else
