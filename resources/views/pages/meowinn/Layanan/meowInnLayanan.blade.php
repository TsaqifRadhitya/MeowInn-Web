<x-meowinn-layout header="Daftar Layanan" id="content" activeMenu="Layanan" class="px-5 pt-5">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <a href="{{ route('meowinn.layanan.create') }}"
            class="btn btn-primary flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600 transition-all shadow-md hover:shadow-lg">
