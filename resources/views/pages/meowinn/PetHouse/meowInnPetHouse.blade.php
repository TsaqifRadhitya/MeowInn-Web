<x-meowinn-layout header="Pet House" class="px-5 pt-5 flex flex-col space-y-5" id="content" activeMenu="Pet House">
    <div>
    ...
    <div class="card card-side bg-base-100 shadow-sm">
        <figure>
            <img class=" " src="https://img.daisyui.com/images/stock/photo-1635805737707-575885ab0820.webp" alt="Movie" />
        </figure>
        <div class="card-body">
