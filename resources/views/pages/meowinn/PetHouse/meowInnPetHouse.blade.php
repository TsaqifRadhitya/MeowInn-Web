<x-meowinn-layout header="Pet House" class="m-5 p-5 rounded-xl shadow-md flex flex-col space-y-5 relative" id="content"
    ...
    @if (count($daftarPethouse) == 0)
        <h1 class="font-semibold">Pethouse Tidak Ditemukan</h1>
    @endif
        ...
        <div class="card card-side bg-base-100 shadow-md">
            ...
            <div class="card-body">
                ...
                <div class="card-actions justify-end">
                    <button class="btn btn-primary" onclick="document.location.href = '/meowinn/preview/{{ $petHouse->id }}'">Watch</button>
                </div>
            </div>
        </div>
    @endforeach
