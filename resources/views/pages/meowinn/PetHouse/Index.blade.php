<x-meowinn-layout header="Pet House" class="m-10" id="content" activeMenu="Pet House">
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        @if (count($daftarPethouse) == 0)
            <div class="bg-gray-50 rounded-lg p-8 text-center border border-gray-200">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-700">Pet House Tidak Ditemukan</h3>
