    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-linear-210 from-[#F69246] via-[#EB6F6F] to-[#C0618C] shadow-sm">
            <ul class="font-medium space-y-8">
                ...
                <li
                    class="{{ $activeMenu == 'Dashboard' ? 'bg-white shadow-sm' : 'hover:bg-white hover:shadow-sm' }} rounded-l-full">
                    ...
                    <ul id="dropdown-Pet-House"
                        ...
                        <li>
                            <a href="{{ route('meowinn.pethouse.penalty.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Penalty</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li
                    class="{{ $activeMenu == 'Reports' ? 'bg-white shadow-sm' : 'hover:bg-white hover:shadow-sm' }} rounded-l-full">
                    ...
                    <ul id="dropdown-Profile"
                        ...
                        <li>
                            <form action="{{ route('logout') }}" method="POST">
                                ...
                                @method('post')
                                <button type="submit"
                                    class="hover:cursor-pointer w-full flex items-center p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    Logout
                                </button>
                            </form>
                        </li>
