        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-linear-210 from-[#F69246] to-[#EC7070] shadow-sm">
            <ul class="font-medium space-y-8">
                ...
                <li
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center p-2 text-gray-900 rounded-lg">
                    ...
                    <ul id="dropdown-Pet-House"
                        ...
                        <li>
                            <a href="{{ route('meowinn.pethouse.daftarpethouse.index') }}"
                                class="{{ $activeMenu == 'Pet House' ? '' : 'text-white hover:text-black' }} flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Daftar
                                Pet House</a>
                        </li>
                        <li>
                ...
                <li>
                    <button type="button"
                        ...
                        class="flex items-center w-full p-2 text-base text-gray-900 {{ $activeMenu == 'Layanan' ? 'bg-white shadow-sm rounded-tl-box' : 'hover:bg-white hover:shadow-sm rounded-l-full text-white hover:text-black' }} transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    ...
                    <ul id="dropdown-Layanan"
                        ...
                        <li>
                            <a href="{{ route('meowinn.layanan.daftarlayanan.index') }}"
                                class="{{ $activeMenu == 'Layanan' ? '' : 'text-white hover:text-black' }} flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Daftar
                                Layanan</a>
                        </li>
                        <li>
                            <a href="{{ route('meowinn.layanan.pengajuanlayanan.index') }}"
                                class="{{ $activeMenu == 'Layanan' ? '' : 'text-white hover:text-black' }} flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Pengajuan
                                Layanan</a>
                        </li>
                    </ul>
                </li>
